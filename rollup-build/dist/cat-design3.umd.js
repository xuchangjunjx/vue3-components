(function (global, factory) {
  ...
  function render$2(_ctx, _cache, $props, $setup, $data, $options) {
    const _directive_clickout = vue.resolveDirective("clickout");
    ...
    return vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, [
      ...
      vue.createElementVNode("div", {
        class: vue.normalizeClass({ 'dropdown-menu': true, 'is-active': this.active })
      }, [
  ...
  const _hoisted_5 = /*#__PURE__*/vue.createTextVNode("取消");
  const _hoisted_6 = /*#__PURE__*/vue.createTextVNode("确定");

  function render$1(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_Button = vue.resolveComponent("Button");

    return (vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass({ modal: true, 'is-active': !!this.currentValue })
    }, [
      vue.createElementVNode("div", {
      ...
      vue.createElementVNode("div", {
        ...
        style: vue.normalizeStyle({ top: $props.top })
      }, [
        vue.createElementVNode("header", _hoisted_1$1, [
          vue.createElementVNode("p", _hoisted_2$1, vue.toDisplayString($props.title), 1 /* TEXT */),
  ...
  const initInstance = app => {
    if (!instance$1) {
      ...
      const vnode = vue.h(ModalComponent); // 类似$mount

      vue.render(vnode, dom); // 添加到body中
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("article", {
      ...
      vue.createElementVNode("div", _hoisted_1, [
        vue.createElementVNode("p", _hoisted_2, vue.toDisplayString($props.text), 1 /* TEXT */),
        vue.createElementVNode("button", {
          class: "delete",
          "aria-label": "delete",
          onClick: _cache[0] || (_cache[0] = (...args) => ($options.handleClick && $options.handleClick(...args)))
